            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="">
                            <a href="{{route('admin.category.index')}}"><i class="fa fa-dashboard"></i> <span>Category</span></a>
                        </li>
                        <li class="">
                            <a href="{{route('admin.product.index')}}"><i class="fa fa-dashboard"></i> <span>Product</span></a>
                        </li>
                        <li class="">
                            <a href="{{route('admin.order.index')}}"><i class="fa fa-dashboard"></i> <span>Order</span></a>
                        </li>
						{{-- <li class="submenu">
