                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="{{url('/')}}"><img src="{{asset('assets/images/logo/logo.png')}}" alt="Site Logo" /></a>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="login-content">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="member-register mt-2">
                                    <p class="text-white-50"> Are You Our Member? <a href="login.html"> Login</a></p>
                                </div>
