                                ...
                                <form action="{{route('cart.store')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            {{-- this is for add card only --}}
                                            <input type="hidden" name="product_id" value="{{$product->id??''}}">
                                            <input type="hidden" name="name" value="{{$product->name}}">
                                            <input type="hidden" name="main_price" value="{{$product->main_price}}">
                                            <input type="hidden" name="sale_price" value="{{$product->sale_price}}">
                                            <input type="hidden" name="sku" value="{{$product->sku}}">
                                            <input type="hidden" name="quantity" value="1">
                                            {{--end, this is for add card only --}}
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="{{route('one.product',$product->id)}}">{{$product->name}}
                                                </a>
                                            </h5>
                                            <span class="price">
                                                <span class="new">${{$product->sale_price}}</span>
                                                <span class="old">${{$product->main_price}}</span>
                                            </span>
                                        </div>
                                    </div>
                                </form>
                                    ...
                                    @foreach (App\Models\Product::all() as $data)
                                        ...
                                        <div class="new-product-item swiper-slide">
                                            ...
                                            <div class="product">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img src="{{asset('uploads/product/'.$data->photo)}}" alt="Product" />
                                                    </a>
                                                    <span class="badges">
                                                        <span class="new">New</span>
                                                    </span>
                                                    ...
                                                    <input type="hidden" name="main_price" value="{{$data->main_price}}">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h5 class="title"><a href="single-product.html">{{$data->name}}
                                                        </a>
                                                    </h5>
                                                    <span class="price">
                                                        <span class="new">${{$data->sale_price}}</span>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
